...
export const COUNTING_VECTORS = [
  {
     ...
     */
    sessions: [
      { type: 'focus', status: 'completed', endedAt: '2026-07-27T09:25:00.000Z', actualDurationMs: 25 * MINUTE, taskTitleSnapshot: 'Write the report', terminationReason: null },
      { type: 'break', status: 'completed', endedAt: '2026-07-27T09:30:00.000Z', actualDurationMs: 5 * MINUTE, taskTitleSnapshot: 'Write the report', terminationReason: null },
      { type: 'break', status: 'terminated', endedAt: '2026-07-27T09:34:00.000Z', actualDurationMs: 4 * MINUTE, taskTitleSnapshot: 'Write the report', terminationReason: 'interrupted' },
    ],
...

  {
     ...
     */
    sessions: [
      { type: 'focus', status: 'completed', endedAt: '2026-07-28T10:25:00.000Z', actualDurationMs: 25 * MINUTE, taskTitleSnapshot: 'Refactor the parser', terminationReason: null },
      { type: 'focus', status: 'terminated', endedAt: '2026-07-28T11:20:00.000Z', actualDurationMs: 20 * MINUTE, taskTitleSnapshot: 'Refactor the parser', terminationReason: 'interrupted' },
    ],
...

  {
     ...
     */
    sessions: [
      { type: 'focus', status: 'completed', endedAt: '2026-07-29T09:25:00.000Z', actualDurationMs: 25 * MINUTE, taskTitleSnapshot: 'Read the ADRs', terminationReason: null },
    ],
...

  {
     ...
     */
    sessions: [
      { type: 'focus', status: 'completed', endedAt: '2026-07-30T09:01:30.000Z', actualDurationMs: 90 * 1000, taskTitleSnapshot: 'Tiny one', terminationReason: null },
      { type: 'focus', status: 'terminated', endedAt: '2026-07-30T09:03:00.000Z', actualDurationMs: 90 * 1000, taskTitleSnapshot: 'Tiny one', terminationReason: 'finished_early' },
      { type: 'focus', status: 'terminated', endedAt: '2026-07-30T09:04:30.000Z', actualDurationMs: 90 * 1000, taskTitleSnapshot: 'Tiny one', terminationReason: 'out_of_energy' },
    ],
...

  {
     ...
     */
    sessions: [
      { type: 'focus', status: 'completed', endedAt: '2026-07-31T09:25:00.000Z', actualDurationMs: 25 * MINUTE, taskTitleSnapshot: 'Café ☕ — déjà vu 🌲', terminationReason: null },
      { type: 'focus', status: 'completed', endedAt: '2026-07-31T10:25:00.000Z', actualDurationMs: 25 * MINUTE, taskTitleSnapshot: 'Café ☕ — déjà vu 🌲', terminationReason: null },
    ],
